...
requirements = python3,kivy,openpyxl,jdcal,et_xmlfile,kivymd,jnius
...
presplash.filename = %(source.dir)s/appPicture/background.jpg

# (str) Icon of the application
icon.filename = %(source.dir)s/appPicture/icon.jpg
